...
st.markdown(
    "*A raíz de estas limitaciones, esta vista se deja preparada para posibles expansiones en el futuro donde se tengan datos de varias localizaciones, permitiendo así análisis más interesantes a nivel geográfico.*"
)
